...
void set_attr_flag(job *pjob, int attr_idx, int flag);
void reset_attr_flag(job *pjob, int attr_idx, int flag);
void unset_attr_flag(job *pjob, int attr_idx, int flag);
int set_jattr_generic(job *pjob, int attr_idx, char *val, char *rscn, enum batch_op op);
int is_attr_flag_set(const job *pjob, int attr_idx, int flag);
