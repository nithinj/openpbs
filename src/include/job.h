...
int set_jattr_light(job *pjob, int attr_idx, void *val, enum batch_op op);
int is_jattr_flag_set(const job *pjob, int attr_idx, int flag);
void reset_jattr_flag(job *pjob, int attr_idx, int flag);
void set_jattr_flag(job *pjob, int attr_idx, int flag);
void unset_jattr_flag(job *pjob, int attr_idx, int flag);
